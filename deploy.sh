...
# cp ./components/opa/alfa/src/src-gen/*.xml ./components/xacml-pdp/pdp/conf/policies/
...
#
docker compose --project-name opa-authorization-manager up --force-recreate -d
if [ $? -ne 0 ]; then
